namespace eSpeakNGLib
{
    ...
    {
        public const int ListVoices = 223;
        ...
        */
        ...
        /*            
            ...
            64 English (America, New York City)
        */
        public static int Caribbean = 53;
        public static int GreatBritain = 54;
        public static int Scotland = 55;
        public static int Lancaster = 56;
        public static int WestMidlands = 57;
        public static int America = 60;
        public static int NewYorkCity = 64;

        public static int RandomEnglish()
        {
            int rng = (int)System.Random.Shared.Next(0, 7);
            if (rng == 0)
            {
                return Caribbean;
            }
